...
void DirectXCommon::CreateSwapChain()
{
	...
	swapChainDesc.Height = winApp_->kClientHeight; // 画面の高さ。ウィンドウのクライアント小域を同じものにしておく
	...
	(
		commandQueue.Get(), winApp_->GetHwnd(), &swapChainDesc,
...
void DirectXCommon::CreateDepth() 
{
	...
	// depthStencilリソース
	depthStencilResource = CreatDepthStenCilTextureResource(device, winApp_->kClientWidth, winApp_->kClientHeight);
